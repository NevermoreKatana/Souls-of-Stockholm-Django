"""
Django settings for souls_of_stockholm project.
...
ALLOWED_HOSTS = [
    ...
    '127.0.0.1',
    '0.0.0.0',
    'souls-of-stockholm.onrender.com'
]
...
TEMPLATES = [
    {
        ...
        'DIRS': ['souls_of_stockholm/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
if not DEBUG:
    STATIC_ROOT = os.path.join('souls_of_stockholm', 'staticfiles')
